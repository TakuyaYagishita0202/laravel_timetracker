<template>
    <div class="container mx-auto">
        ...
        <v-snackbar top v-model="deleteTimerSnackbar" color="error">
            記録を削除しました。
            <v-btn text @click="deleteTimerSnackbar = false">
                Close
            </v-btn>
        </v-snackbar>
        ...
        <div class="text-center">
            <v-dialog v-model="newTimerDialog" width="500">
                <v-card>
                    ...
                    <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn text @click="newTimerDialog = false"
                            >CANCEL</v-btn
                        >
                        <v-btn
                            color="blue darken-1"
            ...
            <v-dialog v-model="editTimerDialog" width="500">
                <v-card>
                    ...
                    <v-card-actions>
                        ...
                        >
                            <template v-slot:activator="{ on }">
                                <v-btn text color="red lighten-1" v-on="on"
                                    >DELETE</v-btn
                                >
                            </template>
                            <!-- 削除確認メニュー -->
                            <v-card>
                                ...
                                <v-card-actions>
                                    <v-spacer></v-spacer>
                                    <v-btn text @click="deleteMenu = false"
                                        >CANCEL</v-btn
                                    >
                                    <v-btn
                                        color="red lighten-1"
                        ...
                        <v-spacer></v-spacer>
                        <v-btn <v-btn text @click="editTimerDialog = false"
                            >CANCEL</v-btn
                        >
                        <v-btn
                            color="blue darken-1"
...
export default {
    ...
    methods: {
        ...
        formatTimer: function(timer) {
            ...
            return `${this._formatTime(started)} - ${this._formatTime(
                stopped
            )}`;
        },
